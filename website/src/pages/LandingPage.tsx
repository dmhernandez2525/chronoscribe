  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-secondary-950 to-secondary-900 text-white">
      ...
      <header className="container mx-auto px-6 py-6">
        <nav className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xl font-bold">ChronoScribe</span>
          </div>
          <div className="flex items-center gap-6">
            ...
            <a href="https://github.com/dmhernandez2525/chronoscribe" className="flex items-center gap-2 bg-secondary-800 hover:bg-secondary-700 px-4 py-2 rounded-lg transition-colors">
      ...
      <section className="container mx-auto px-6 py-20 text-center">
        <h1 className="text-5xl md:text-6xl font-bold mb-6 bg-gradient-to-r from-white to-secondary-300 bg-clip-text text-transparent">
          Transform Your Handwritten Legacy<br />Into a Searchable Archive
        </h1>
        ...
        <div className="flex gap-4 justify-center">
          ...
          <a 
            href="#how-it-works" 
            className="border border-secondary-600 hover:bg-secondary-800 px-8 py-3 rounded-lg font-semibold transition-colors"
          >
            Learn More
          </a>
        </div>
        ...
        <div className="mt-16 max-w-4xl mx-auto">
          <div className="bg-secondary-900 rounded-lg border border-secondary-700 overflow-hidden shadow-2xl">
            <div className="bg-secondary-800 px-4 py-2 flex items-center gap-2">
      ...
      <section className="container mx-auto px-6 py-20">
        <h2 className="text-3xl font-bold text-center mb-12">Simple CLI Interface</h2>
      ...
      {/* CTA */}
      <section className="container mx-auto px-6 py-20 text-center">
        <h2 className="text-3xl font-bold mb-6">Ready to Digitize Your Legacy?</h2>
      ...
      {/* Footer */}
      <footer className="container mx-auto px-6 py-8 border-t border-secondary-800">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            <FileText className="h-6 w-6 text-primary-500" />
            <span className="font-semibold">ChronoScribe</span>
          </div>
...
function FeatureCard({ icon, title, description }: { icon: React.ReactNode, title: string, description: string }) {
  return (
    <div className="bg-secondary-800/50 border border-secondary-700 rounded-lg p-6 hover:border-primary-500/50 transition-colors">
...
function Step({ number, title, children }: { number: number, title: string, children: React.ReactNode }) {
  return (
    <div className="flex gap-6">
      <div className="flex-shrink-0 w-12 h-12 bg-primary-600 rounded-full flex items-center justify-center text-xl font-bold">
        {number}
      </div>
      <div>
        <h3 className="text-xl font-semibold mb-2">{title}</h3>
        <p className="text-secondary-300">{children}</p>
      </div>
    </div>
  )
}
...
function CommandLine({ cmd, desc }: { cmd: string, desc: string }) {
  return (
    <div className="flex items-start gap-4">
      ...
      <span className="text-secondary-500 text-xs"># {desc}</span>
    </div>
  )
}
